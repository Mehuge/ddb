...
class RemoteInstance {
  ...
  async getLastBackup() {
    // Not yet implemented. For this to work the last backup log would need downloading
    // from the backup server to provide the previous hashes. Debatable if doing this
    // will provide an overall speed up, it would depend on the speed of the network vs
    // speed of the disk.
  }
