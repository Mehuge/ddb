  ...
  _init() {
    function re(patterns) {
      ...
      for (let i = 0; i < patterns.length; i++) {
        ...
        // Add a path-boundary suffix unless the pattern already ends with a
        // wildcard or path separator.  This ensures that e.g. -**/temp matches
        // "temp" and "temp/foo" but NOT "templates".
        const endsWild = /[*\\/]$/.test(p);
